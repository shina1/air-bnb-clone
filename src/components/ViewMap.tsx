...
const ViewMap = () => {
  return (
    <Box className='showMap' sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems:'center', position: 'fixed', bottom:100, left: {xs: '35vw', md: '45vw'}, borderRadius: 10, backgroundColor: '#000', px: 2, py: 2, zIndex: 100, width: {xs: '100px', md:'150px'}}}>
